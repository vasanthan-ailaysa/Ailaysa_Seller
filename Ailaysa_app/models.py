...
class Book(models.Model):
    ...
    title_in_original_language = models.CharField(max_length=50, null=True, blank=True)
    co_publisher = models.CharField(max_length=100, null=True, blank=True)
    winner = models.TextField(null=True, blank=True)
    country_of_publication = models.CharField(max_length=100, help_text="Country of publication", null=True, blank=True)
